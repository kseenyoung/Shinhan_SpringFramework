...
<link rel="stylesheet" href="${basepath}/resources/css/chatting.css" />
<script
...
<body>
	...
	<script>
		...
		$('#btnConnect').click(function() {         
			...
			ws = new WebSocket("ws://" + location.host + "/${basepath}/chatserver");  // location.host = localhost:9999
		...
		$(function() {
			var aa = rand(1,15);
			$("#chat").css({"background-image": `url("${basepath}/resources/image/chat_bg\${aa}.jpg")`});
		});
	</script>
</body>
</html>
