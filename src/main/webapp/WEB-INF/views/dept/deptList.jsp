...
<body>
	...
	<div class="container">
		...
		<button id="btnInsert" type="button" class="btn btn-primary"
			data-bs-toggle="modal" data-bs-target="#myModal">신규등록(모달button)</button>

		<a href="#myModal" type="button" class="btn btn-primary"
			data-bs-toggle="modal">신규등록(모달a)</a>

		<hr>
		<h1>부서목록</h1>
		<table
			class="table table-bordered border-secondary table-striped align-middle">
			...
			<c:forEach items="${deptlist}" var="dept">
				<tr class="table">
					<td><a href="detail.do?deptid=${dept.department_id}">${dept.department_id}
					</a>
						<button id="btnUpdate" class="badge badge-pill badge-danger"
							...
							data-locid="${dept.location_id}" data-mid="${dept.manager_id}">상세</button>
					...
					<td>
						<form action="delete.do" method="post">
							...
							<input type="submit" value="삭제(post)" class="btn btn-secondary"
					...
					<form action="detail.do" method="post">
						...
						<div class="input-group mb-3">
							<span class="input-group-text">부서장</span> <input type="number"
								required="required" class="form-control" name="manager_id">
						</div>
						<div class="input-group mb-3">
							<span class="input-group-text">지역번호</span> <input type="number"
								required="required" class="form-control" name="location_id">
						</div>
